...
--
-- font_size 20 matches card_back.place_of_issue, the closest sibling by
-- role (a secondary line, not the primary bold 25pt name); the new
-- card_back.woreda_name row uses 25 to match its existing card_front
-- counterpart rather than printing the same logical field at two sizes.
INSERT INTO public.id_card_template_field (template_field_id, template_type, field_key, x, y, width, height, font_size, font_weight, text_align, z_index, canvas_width, canvas_height, field_type, color, font_family, font_style, text_decoration, binding_mode, static_value) VALUES ('e6e099e6-f712-4325-bdde-e3e4fbe88d1e', 'card_front', 'woreda_name_har', '595', '745', '316', '60', '20', 'normal', 'left', '2', '1688', '1063', 'text', '#000000', 'Inter', 'normal', 'none', 'bound', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.id_card_template_field (template_field_id, template_type, field_key, x, y, width, height, font_size, font_weight, text_align, z_index, canvas_width, canvas_height, field_type, color, font_family, font_style, text_decoration, binding_mode, static_value) VALUES ('267c653d-ea98-4366-930b-efc790c40a90', 'card_front', 'woreda_name_om', '935', '745', '258', '60', '20', 'normal', 'left', '2', '1688', '1063', 'text', '#000000', 'Inter', 'normal', 'none', 'bound', NULL) ON CONFLICT DO NOTHING;
