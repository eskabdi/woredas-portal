...
import { Heart, Users, ArrowLeft, Save, MapPin } from "lucide-react";
...
const schema = z.object({
  ...
  officiant: z.string().trim().max(200).optional().default(""),
  witness1_name: z.string().trim().max(200).optional().default(""),
  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={onSubmit} className="space-y-6">
        <Section icon={Users} titleAm="ተጋቢዎች" titleEn="Spouses">
          <Grid>
            <FieldWrap labelAm="ተጋቢ 1 (የተመዘገበ)" labelEn="Spouse 1 (registered)" colSpan2>
            ...
            <FieldWrap labelAm="ተጋቢ 2 (የተመዘገበ)" labelEn="Spouse 2 (registered)" colSpan2>
              <ResidentSearchPicker
        ...
        <Section icon={MapPin} titleAm="የጋብቻ ዝርዝር" titleEn="Marriage Details">
          <Grid>
            <FieldWrap
              labelAm="የጋብቻ ቀን"
            ...
            <FieldWrap labelAm="ስፍራ" labelEn="Place">
              <Input {...register("place")} />
            </FieldWrap>
            <FieldWrap labelAm="ያከናወነው" labelEn="Officiant (religious/civil)">
              <Input {...register("officiant")} />
            </FieldWrap>
            <FieldWrap labelAm="የምስክር ወረቀት ቁ." labelEn="Certificate Reference">
              <Input {...register("certificate_reference")} />
            </FieldWrap>
            <FieldWrap labelAm="ምስክር 1" labelEn="Witness 1">
              <Input {...register("witness1_name")} />
            </FieldWrap>
            <FieldWrap labelAm="ምስክር 2" labelEn="Witness 2">
              <Input {...register("witness2_name")} />
            </FieldWrap>
