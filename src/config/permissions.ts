...
export const NAV_PERMISSION_MAP: NavItem[] = [
  { labelAm: "ዳሽቦርድ", labelEn: "Dashboard", icon: "LayoutDashboard", href: "/woreda/dashboard", permission: null },
  ...
  { labelAm: "የነዋሪ መታወቂያ", labelEn: "Credentials", icon: "CreditCard", href: "/woreda/credentials", permission: P.CREDENTIAL_READ, moduleKey: "credentials" },
  { labelAm: "መታወቂያ ያረጋግጡ", labelEn: "Verify ID", icon: "ShieldCheck", href: "/woreda/credentials/verify", permission: P.CREDENTIAL_VERIFY },
  { labelAm: "የኩነት ምዝገባ", labelEn: "Civil Registration", icon: "FileText", href: "/woreda/civil", permission: P.CIVIL_READ, moduleKey: "civil_registration" },
  { labelAm: "የቀበሌ የኪራይ ቤቶች", labelEn: "Kebele Rental Houses", icon: "Building2", href: "/woreda/rental-houses", permission: P.RENTAL_VIEW },
  { labelAm: "አገልግሎት ጥያቄዎች", labelEn: "Service Requests", icon: "MailQuestion", href: "/woreda/services", permission: P.SERVICE_READ, moduleKey: "services" },
  { labelAm: "ቅሬታዎች", labelEn: "Complaints", icon: "MessageSquareWarning", href: "/woreda/complaints", permission: P.SERVICE_READ, moduleKey: "services" },
  { labelAm: "የማጽደቅ ወረፋ", labelEn: "Approval Queue", icon: "Inbox", href: "/woreda/approvals", permission: P.APPROVAL_QUEUE_VIEW, moduleKey: "approvals" },
  { labelAm: "ገቢ", labelEn: "Revenue", icon: "Banknote", href: "/woreda/revenue", permission: P.REVENUE_VIEW, moduleKey: "revenue" },
  { labelAm: "ሪፖርቶች", labelEn: "Reports", icon: "BarChart3", href: "/woreda/reports", permission: P.REPORT_VIEW, moduleKey: "reports" },
  { labelAm: "ኦዲት", labelEn: "Audit Trail", icon: "ScrollText", href: "/woreda/audit", permission: P.AUDIT_VIEW, moduleKey: "audit" },
