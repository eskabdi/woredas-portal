  ...
  return (
    <div>
      <div className="grid grid-cols-3 gap-2">
        ...
        />
        <select
          className="font-am-body flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60"
          value={month}
          disabled={disabled}
          onChange={(e) => {
