# 06 — Testing Scope (INSA Phase 6) — DRAFT

Draft by audit-ops-scope, 2026-09-24. It is intended to replace `docs/testing-scope.md` (stale, see
WP-OPS-012) once the system owner reviews it. It covers checklist items F-01, F-02 and F-03.
**The document contains placeholders only. No real credential, token, password or key may ever
be written into it or into any tracked file.**
