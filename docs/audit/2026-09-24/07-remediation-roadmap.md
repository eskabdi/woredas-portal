...
| QW-5 | **WP-LOC-014** | Rename woreda 5 to "Jinala" (additive migration + `seed.sql` + README), once the owner confirms the Amharic form. **Status 2026-09-25: English name done in code (migration `00000000000092`, seed, README); not yet applied; Amharic form still awaits the owner.** | DB | S |
